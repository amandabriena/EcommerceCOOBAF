<?php
    ...
    function retorno_html($id_produto, $nome, $imagem, $preco, $status){
        $result = "<div class='col-lg-4 col-md-6 text-center '>
    ...
    if(isset($_SESSION['cooperado'])){
        ...
        if(mysqli_num_rows($resultado)<=0){
            ...
            while($row = mysqli_fetch_assoc($resultadogeral)){
                echo retorno_html($row['id_produto'], $row['nome'], $row['imagem'], $row['preco'], $row['status']);
            }
        }else{
